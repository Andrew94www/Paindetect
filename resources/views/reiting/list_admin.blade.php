                        ...
                        <tr class="hover:bg-slate-700/30 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 text-center no-print">
                                <div class="flex items-center justify-center gap-2">
                                    <button onclick="openEditModal('{{ $item->id }}', '{{ addslashes($item->name) }}', '{{ $item->position }}', '{{ $item->totalScore }}')" class="p-2 text-slate-400 hover:text-blue-400 transition-all">
                                    ...
                                    <form action="/deletion/teachers/{{ $item->id }}" method="POST" class="delete-form inline">
                                        @csrf
                                        <button type="button" onclick="confirmDeletion(this.closest('form'))" class="p-2 text-slate-400 hover:text-red-400 transition-all">
