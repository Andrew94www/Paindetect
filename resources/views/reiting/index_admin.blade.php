...
<script>
    ...
    const departments = [
        ...
        { name: "Кафедра клінічної фармації", category: "clinical", link: "/admin/department/clin-pharmacy" },
        { name: "Кафедра медицини катастроф та військової медицини", category: "clinical", link: "/admin/department/military-med" },
        { name: "Кафедра нервових хвороб", category: "clinical", link: "/admin/department/neurology" },
        { name: "Кафедра променевої діагностики та онкології", category: "clinical", link: "/admin/department/oncology" },
        ...
        { name: "Кафедра психіатрії та наркології", category: "clinical", link: "/admin/department/psychiatry" },
