...
<div class="controls-wrapper">
    ...
    <div class="button-group">
        ...
        <div style="margin-top: 15px;">
            <a href="{{ route('repain') }}" style="width: 100%;  border-radius: 10px; display: inline-block; box-shadow: 4px 2px 10px rgba(0, 0, 0, 0.3);" class="button">
                <img src="img/repain.jpg" alt="" style="width:200px; height:167px;">
            </a>
        </div>
        <div style="margin-top: 15px;">
